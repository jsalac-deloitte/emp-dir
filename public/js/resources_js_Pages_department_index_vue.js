...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(_ref) {
    ...
    var currentUrl = (0,vue__WEBPACK_IMPORTED_MODULE_8__.ref)("/departments?page=1");
    ...
    function getList() {
      _api_httpService_js__WEBPACK_IMPORTED_MODULE_10__["default"].get("/departments/get-list/all", dtOptions).then(function (response) {
    ...
    function removeRecord(record) {
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_11__.Inertia["delete"]("departments/".concat(record.id));
      getList();
    }
    /**
     * refresh the list
